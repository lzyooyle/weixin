...
wx.config({
  ...
  var wstitle = "旅行分享会| 看世界，心远行";  //此处填写分享标题
  var wsdesc = "跟旅行达人一起神游世界 ！"; //此处填写分享简介
  var wslink = "<?php echo "http://".$_SERVER["HTTP_HOST"].$_SERVER["PHP_SELF"]."?id=".$_GET['id']."&from_openid=".$user['openid']."&from_nickname=".$user['nickname']; ?>"; //此处获取分享链接
  var wsimg = "https://ss0.baidu.com/73F1bjeh1BF3odCf/it/u=234309819,484993811&fm=85&s=59A437764BA243300AE606EE0300702A"; //此处获取分享缩略图
